...
const I18N = {
  pt: {
    ...
    ferias: {
      ...
      sub: "Apartamento remodelado com vista para a piscina e jardins do condomínio. A poucos minutos do centro de Vilamoura, da marina e das praias — e a 2 minutos dos campos de golfe.",
      ...
      descP1: "Apartamento remodelado recentemente, com vista para a piscina e jardins do condomínio, numa zona tranquila do Villa Nature. A poucos minutos do centro de Vilamoura, da marina e das praias da região.",
  ...
  en: {
    ...
    ferias: {
      ...
      sub: "Recently redecorated apartment with views over the condominium's pool and gardens. Just minutes from central Vilamoura, the marina and the beaches — and 2 minutes from the golf courses.",
      ...
      descP1: "Recently redecorated apartment, with views over the condominium's pool and gardens, in a quiet part of Villa Nature. Just minutes from central Vilamoura, the marina and the region's beaches.",
  ...
  pl: {
    ...
    ferias: {
      ...
      sub: "Niedawno odnowiony apartament z widokiem na basen i ogrody kompleksu. Kilka minut od centrum Vilamoura, mariny i plaż — oraz 2 minuty od pól golfowych.",
      ...
      descP1: "Niedawno odnowiony apartament z widokiem na basen i ogrody kompleksu, w spokojnej części Villa Nature. Kilka minut od centrum Vilamoura, mariny i plaż regionu.",
