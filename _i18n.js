...
const I18N = {
  pt: {
    ...
    listingOlhos: {
      title: "Moradia geminada com piscina,<br><em>a 5 minutos de Albufeira.</em>",
      sub: "252 m² distribuídos por 4 quartos e 4 casas de banho, com piscina privada, terraços e garagem de 80 m² — num condomínio tranquilo de sete moradias em Olhos de Água.",
      factArea: "Área Útil", factRooms: "Quartos", factWc: "Casas de Banho",
      factGarage: "Garagem", factLand: "Terreno", factPrice: "Preço",
      ctaVisit: "Agendar Visita →",
      energyLabel: "Certificado Energético",
      descH2: "Uma moradia luminosa, a poucos minutos da praia.",
      descP1: "Localizada num condomínio tranquilo de sete moradias, em Olhos de Água, esta casa geminada é de construção recente e está em estado quase novo, com acabamentos contemporâneos e uma disposição interior pensada para dar prioridade à luz natural.",
      descP2: "No rés-do-chão, uma ampla sala com cozinha aberta totalmente equipada abre para dois terraços — um virado a sul com piscina privada, outro virado a norte com cozinha exterior. No 1º andar, três quartos, cada um com a sua própria casa de banho.",
      descP3: "A cave inclui uma garagem privativa fechada de 80 m², com zona de lavandaria e arrumos. Vidros duplos com corte térmico, ar condicionado reversível e painéis solares já instalados — a 5 minutos de Albufeira e a 1,5 km da praia.",
      compTitle: "Composição, Piso a Piso",
      compRC: "Rés-do-Chão", compRC1: "Sala com cozinha aberta totalmente equipada",
      compRC2: "1 quarto com casa de banho própria", compRC3: "2 terraços — piscina (sul) e cozinha exterior (norte)",
      comp1: "1º Andar", comp1a: "3 quartos, cada um com casa de banho própria e terraço",
      compCave: "Cave", compCave1: "Garagem privativa fechada de 80 m²", compCave2: "Lavandaria e zona de arrumos",
    ...
    listingQuarteira: {
      ...
      descP1: "Situado num dos bairros mais procurados de Quarteira, a poucos minutos a pé da praia, este duplex de 4 quartos oferece espaços generosos, excelente luminosidade e uma vista desafogada sobre o mar.",
      descP2: "Graças à sua configuração, o duplex pode funcionar facilmente como dois apartamentos independentes — ideal para conciliar residência própria com rendimento de arrendamento, ou para acolher família e amigos com total autonomia.",
      descP3: "Em excelente estado e pronto a habitar, com estacionamento privado incluído.",
      compTitle: "Composição, Piso a Piso",
      compL1: "1º Piso", compL1a: "Cozinha totalmente equipada com acesso a varanda",
      compL1b: "Sala ampla e luminosa com acesso direto a varanda", compL1c: "2 quartos, um deles suite",
      compL1d: "2 casas de banho", compL1e: "2 varandas, uma com churrasqueira integrada",
      compL2: "Piso Superior (Sótão Habitável)", compL2a: "2 quartos", compL2b: "1 casa de banho",
      compL2c: "Espaço de estar amplo com cozinha totalmente equipada",
      compL2d: "Acesso direto a um terraço amplo, com vista panorâmica sobre Quarteira e o oceano",
    ...
    listingPataVillage: {
      title: "Moradia V3 em Banda,<br><em>no condomínio Patã Village.</em>",
      sub: "137 m² distribuídos por cave, rés do chão e 1º andar, num condomínio fechado em Patã de Baixo, Albufeira, com piscina para adultos e crianças, portão elétrico e vídeo-porteiro.",
      factArea: "Área Útil", factRooms: "Quartos", factWc: "Casas de Banho",
      factFloorsLbl: "Configuração", factFloorsVal: "Moradia em Banda",
      factParkingLbl: "Estacionamento", factParkingVal: "Garagem (2-3 lug.)", factPrice: "Preço",
      ctaVisit: "Agendar Visita →",
      energyLabel: "Certificado Energético",
      descH2: "Uma moradia luminosa, num condomínio fechado e tranquilo.",
      descP1: "Inserida no condomínio fechado Patã Village, em Patã de Baixo, Albufeira, esta elegante moradia V3 em banda, construída em 2010, destaca-se pela sua arquitetura contemporânea, excelente exposição solar e localização central — perto de comércio, escolas, campos de golfe e das melhores praias do Algarve.",
      descP2: "No rés do chão, uma acolhedora sala de estar beneficia de uma ampla janela panorâmica orientada a nascente e de um sistema retrátil em vidro que dá acesso a uma varanda. A cozinha é independente e totalmente equipada. A partir da cozinha acede-se a um segundo terraço, também com fecho em vidro, atualmente usado como sala de jantar, com churrasqueira e acesso direto ao jardim.",
      descP3: "No 1º andar, três quartos com roupeiros embutidos e duas casas de banho — a suite principal com casa de banho privativa e uma extensa varanda aberta. Na cave, uma ampla garagem com capacidade para dois a três veículos, com potencial para arrecadação, oficina ou ginásio.",
      compTitle: "Composição, Piso a Piso",
      compL1: "Rés do Chão", compL1a: "Sala de estar com varanda envidraçada retrátil",
      compL1b: "Cozinha independente, totalmente equipada", compL1c: "1 casa de banho social",
      compL1d: "Segundo terraço com churrasqueira, usado como sala de jantar, com acesso ao jardim",
      compL2: "1º Piso", compL2a: "3 quartos com roupeiros embutidos",
      compL2b: "2 casas de banho, uma delas privativa da suite", compL2c: "Suite principal com varanda aberta e vista desafogada",
      compL3: "Cave", compL3a: "Garagem para 2 a 3 carros, com potencial para arrecadação, oficina ou ginásio",
      contactH2: "Interessado nesta moradia?",
      phMsg: "Gostaria de agendar uma visita…"
    },
  ...
  en: {
    ...
    listingOlhos: {
      title: "Semi-detached villa with pool,<br><em>5 minutes from Albufeira.</em>",
      sub: "252 m² across 4 bedrooms and 4 bathrooms, with a private pool, terraces and an 80 m² garage — in a quiet complex of seven villas in Olhos de Água.",
      factArea: "Living Area", factRooms: "Bedrooms", factWc: "Bathrooms",
      factGarage: "Garage", factLand: "Plot", factPrice: "Price",
      ctaVisit: "Schedule a Visit →",
      energyLabel: "Energy Performance Certificate",
      descH2: "A bright villa, minutes from the beach.",
      descP1: "Located in a quiet complex of seven villas in Olhos de Água, this semi-detached house is recently built and in near-new condition, with contemporary finishes and a layout designed around natural light.",
      descP2: "On the ground floor, a spacious living area with a fully equipped open kitchen opens onto two terraces — one south-facing with a private pool, the other north-facing with an outdoor kitchen. On the first floor, three bedrooms, each with its own bathroom.",
      descP3: "The basement includes a private enclosed 80 m² garage, with a laundry area and storage. Double glazing with thermal break, reversible air-conditioning and solar panels already installed — 5 minutes from Albufeira and 1.5 km from the beach.",
      compTitle: "Layout, Floor by Floor",
      compRC: "Ground Floor", compRC1: "Living area with fully equipped open kitchen",
      compRC2: "1 bedroom with en-suite bathroom", compRC3: "2 terraces — pool (south) and outdoor kitchen (north)",
      comp1: "First Floor", comp1a: "3 bedrooms, each with its own bathroom and terrace",
      compCave: "Basement", compCave1: "Private enclosed 80 m² garage", compCave2: "Laundry and storage area",
    ...
    listingQuarteira: {
      ...
      descP1: "Located in one of Quarteira's most sought-after neighbourhoods, just minutes on foot from the beach, this 4-bedroom duplex offers generous spaces, excellent natural light and an open view over the sea.",
      descP2: "Thanks to its layout, the duplex can easily work as two independent apartments — ideal for combining a primary residence with rental income, or for hosting family and friends with full independence.",
      descP3: "In excellent condition and move-in ready, with private parking included.",
      compTitle: "Layout, Floor by Floor",
      compL1: "First Floor", compL1a: "Fully equipped kitchen with balcony access",
      compL1b: "Bright, spacious living room with direct balcony access", compL1c: "2 bedrooms, one en-suite",
      compL1d: "2 bathrooms", compL1e: "2 balconies, one with a built-in barbecue",
      compL2: "Upper Floor (Converted Loft)", compL2a: "2 bedrooms", compL2b: "1 bathroom",
      compL2c: "Large living space with fully equipped kitchen",
      compL2d: "Direct access to a large terrace, with panoramic views over Quarteira and the ocean",
    ...
    listingPataVillage: {
      title: "3-Bed Terraced Villa,<br><em>in the Patã Village condominium.</em>",
      sub: "137 m² across basement, ground and first floor, in a gated condominium in Patã de Baixo, Albufeira, with a pool for adults and children, electric gate and video intercom.",
      factArea: "Living Area", factRooms: "Bedrooms", factWc: "Bathrooms",
      factFloorsLbl: "Layout", factFloorsVal: "Terraced Villa",
      factParkingLbl: "Parking", factParkingVal: "Garage (2-3 cars)", factPrice: "Price",
      ctaVisit: "Schedule a Visit →",
      energyLabel: "Energy Performance Certificate",
      descH2: "A bright villa in a quiet, gated condominium.",
      descP1: "Located in the gated Patã Village condominium, in Patã de Baixo, Albufeira, this elegant 3-bedroom terraced villa, built in 2010, stands out for its contemporary architecture, excellent sun exposure and central location — close to shops, schools, golf courses and the best beaches in the Algarve.",
      descP2: "On the ground floor, a welcoming living room benefits from a large east-facing panoramic window and a retractable glass system opening onto a balcony. The kitchen is independent and fully equipped. From the kitchen, a second terrace — also glass-enclosed — is currently used as a dining room, with a barbecue and direct garden access.",
      descP3: "On the first floor, three bedrooms with built-in wardrobes and two bathrooms — the main suite with a private bathroom and a large open balcony. In the basement, a spacious garage for two to three vehicles, with potential for storage, a workshop or a private gym.",
      compTitle: "Layout, Floor by Floor",
      compL1: "Ground Floor", compL1a: "Living room with retractable glass balcony",
      compL1b: "Independent, fully equipped kitchen", compL1c: "1 guest bathroom",
      compL1d: "Second terrace with barbecue, used as a dining room, with garden access",
      compL2: "First Floor", compL2a: "3 bedrooms with built-in wardrobes",
      compL2b: "2 bathrooms, one en-suite", compL2c: "Main suite with open balcony and open views",
      compL3: "Basement", compL3a: "Garage for 2 to 3 cars, with potential for storage, a workshop or a gym",
      contactH2: "Interested in this villa?",
      phMsg: "I'd like to schedule a visit…"
    },
    listingVilamouraTerraco: {
  ...
  pl: {
    ...
    listingOlhos: {
      title: "Bliźniak z basenem,<br><em>5 minut od Albufeiry.</em>",
      sub: "252 m² na 4 sypialnie i 4 łazienki, z prywatnym basenem, tarasami i garażem 80 m² — w spokojnym kompleksie siedmiu willi w Olhos de Água.",
      factArea: "Powierzchnia Użytkowa", factRooms: "Sypialnie", factWc: "Łazienki",
      factGarage: "Garaż", factLand: "Działka", factPrice: "Cena",
      ctaVisit: "Umów Wizytę →",
      energyLabel: "Świadectwo Charakterystyki Energetycznej",
      descH2: "Jasna willa, kilka minut od plaży.",
      descP1: "Ten bliźniak, położony w spokojnym kompleksie siedmiu willi w Olhos de Água, jest niedawno wybudowany i w niemal nowym stanie, z nowoczesnym wykończeniem i układem zaprojektowanym z myślą o naturalnym świetle.",
      descP2: "Na parterze przestronny salon z w pełni wyposażoną otwartą kuchnią prowadzi na dwa tarasy — jeden od południa z prywatnym basenem, drugi od północy z kuchnią zewnętrzną. Na pierwszym piętrze trzy sypialnie, każda z własną łazienką.",
      descP3: "Piwnica obejmuje prywatny, zamknięty garaż o powierzchni 80 m², z pralnią i pomieszczeniem gospodarczym. Podwójne szyby z przekładką termiczną, klimatyzacja rewersyjna i już zainstalowane panele słoneczne — 5 minut od Albufeiry i 1,5 km od plaży.",
      compTitle: "Układ, Piętro po Piętrze",
      compRC: "Parter", compRC1: "Salon z w pełni wyposażoną otwartą kuchnią",
      compRC2: "1 sypialnia z łazienką", compRC3: "2 tarasy — basen (południe) i kuchnia zewnętrzna (północ)",
      comp1: "Pierwsze Piętro", comp1a: "3 sypialnie, każda z własną łazienką i tarasem",
      compCave: "Piwnica", compCave1: "Prywatny, zamknięty garaż 80 m²", compCave2: "Pralnia i pomieszczenie gospodarcze",
      contactH2: "Zainteresowany tą willą?",
      phMsg: "Chciałbym umówić wizytę…"
    },
    listingQuarteira: {
      ...
      descP1: "Położony w jednej z najbardziej pożądanych okolic Quarteiry, kilka minut pieszo od plaży, ten 4-pokojowy duplex oferuje przestronne wnętrza, doskonałe naturalne światło i otwarty widok na morze.",
      descP2: "Dzięki swojemu układowi duplex może z łatwością funkcjonować jako dwa niezależne mieszkania — idealne rozwiązanie łączące własne mieszkanie z dochodem z wynajmu, lub do przyjmowania rodziny i przyjaciół z pełną niezależnością.",
      descP3: "W doskonałym stanie i gotowy do zamieszkania, z wliczonym prywatnym miejscem parkingowym.",
      compTitle: "Układ, Piętro po Piętrze",
      compL1: "Pierwsze Piętro", compL1a: "W pełni wyposażona kuchnia z dostępem do balkonu",
      compL1b: "Jasny, przestronny salon z bezpośrednim dostępem do balkonu", compL1c: "2 sypialnie, jedna z łazienką",
      compL1d: "2 łazienki", compL1e: "2 balkony, jeden z wbudowanym grillem",
      compL2: "Górne Piętro (Zaadaptowane Poddasze)", compL2a: "2 sypialnie", compL2b: "1 łazienka",
    ...
    listingPataVillage: {
      title: "Dom szeregowy 3-pokojowy,<br><em>w osiedlu Patã Village.</em>",
      sub: "137 m² na piwnicę, parter i piętro, w zamkniętym osiedlu w Patã de Baixo, Albufeira, z basenem dla dorosłych i dzieci, bramą elektryczną i wideodomofonem.",
      factArea: "Powierzchnia Użytkowa", factRooms: "Sypialnie", factWc: "Łazienki",
      factFloorsLbl: "Układ", factFloorsVal: "Dom Szeregowy",
      factParkingLbl: "Parking", factParkingVal: "Garaż (2-3 aut.)", factPrice: "Cena",
      ctaVisit: "Umów Wizytę →",
      energyLabel: "Świadectwo Charakterystyki Energetycznej",
      descH2: "Jasny dom w spokojnym, zamkniętym osiedlu.",
      descP1: "Położony w zamkniętym osiedlu Patã Village, w Patã de Baixo, Albufeira, ten elegancki 3-pokojowy dom szeregowy, wybudowany w 2010 roku, wyróżnia się współczesną architekturą, doskonałym nasłonecznieniem i centralną lokalizacją — blisko sklepów, szkół, pól golfowych i najlepszych plaż Algarve.",
      descP2: "Na parterze przytulny salon korzysta z dużego, skierowanego na wschód panoramicznego okna oraz rozsuwanego systemu szklanego prowadzącego na balkon. Kuchnia jest niezależna i w pełni wyposażona. Z kuchni dostępny jest drugi taras — również przeszklony — obecnie użytkowany jako jadalnia, z grillem i bezpośrednim dostępem do ogrodu.",
      descP3: "Na piętrze trzy sypialnie z szafami wnękowymi i dwie łazienki — sypialnia główna z prywatną łazienką i dużym otwartym balkonem. W piwnicy przestronny garaż na dwa do trzech pojazdów, z potencjałem na pomieszczenie gospodarcze, warsztat lub prywatną siłownię.",
      compTitle: "Układ, Piętro po Piętrze",
      compL1: "Parter", compL1a: "Salon z rozsuwanym przeszklonym balkonem",
      compL1b: "Niezależna, w pełni wyposażona kuchnia", compL1c: "1 łazienka dla gości",
      compL1d: "Drugi taras z grillem, używany jako jadalnia, z dostępem do ogrodu",
      compL2: "Piętro", compL2a: "3 sypialnie z szafami wnękowymi",
